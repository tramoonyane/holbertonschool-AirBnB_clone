...
class TestAmenity(unittest.TestCase):
    ...
    def test_instance(self):
        """Test if instances are of Amenity"""
    ...
    def test_to_dict(self):
        """Test if to_dict method works properly for Amenity instances"""
        amenity_dict = self.obj1.to_dict()
    ...
    def test_style_check(self):
        """Test pycodestyle"""
        style = os.system("pycodestyle models/amenity.py")
